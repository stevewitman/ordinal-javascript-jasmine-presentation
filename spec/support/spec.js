...
describe("ordinal()", function() {
  ...
  it("returns n + 'st' when n ends in 1", function() {
    expect(Source.ordinal(251)).toEqual("251st");
  }); 

  it("returns n + 'nd' when n ends in 2", function() {
    expect(Source.ordinal(422)).toEqual("422nd");
  });

  it("returns n + 'rd' when n ends in 3", function() {
